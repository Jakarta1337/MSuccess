                                                    ...
                                                    <td>
                                                        <div class="date">
                                                            ...
                                                            <ul class="teacher-date-list">
                                                                <li><i class="fas fa-calendar-alt me-2"></i>Feb 8,
                                                                    2024</li>
                                                                <li>|</li>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="date">
                                                            ...
                                                            <p>1.1 Part 1</p>
                                                            <ul class="teacher-date-list">
                                                                <li><i class="fas fa-calendar-alt me-2"></i>Feb 1,
                                                                    2024</li>
                                                                <li>|</li>
                                                                <li><i class="fas fa-clock me-2"></i>09:00 - 10:00
                                                                    am</li>
                                        ...
                                        <ul class="activity-feed">
                                            <li class="feed-item d-flex align-items-center">
                                                <div class="dolor-activity">
                                                    ...
                                                    <ul class="teacher-date-list">
                                                        <li><i class="fas fa-calendar-alt me-2"></i>February 1,
                                                            2024</li>
                                                        <li>|</li>
                                            ...
                                            <li class="feed-item d-flex align-items-center">
                                                <div class="dolor-activity">
                                                    ...
                                                    <ul class="teacher-date-list">
                                                        <li><i class="fas fa-calendar-alt me-2"></i>January 18,
                                                            2024</li>
                                                        <li>|</li>
                                                        <li><i class="fas fa-clock me-2"></i>09:00 am - 10:00 am (60
                                                            Minutes)</li>
                            ...
                            <div class="calendar-info calendar-info1">
                                ...
                                <div class="calendar-details">
                                    ...
                                    <div class="calendar-box normal-bg">
                                        <div class="calandar-event-name">
                                            <h4>Computer science</h4>
                                            <h5>More practical work</h5>
                                        </div>
                                        <span>11:15 - 12:15 am</span>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\zakar\Downloads\school_system_laravel_10-main\resources\views/dashboard/teacher_dashboard.blade.php ENDPATH**/ ?>