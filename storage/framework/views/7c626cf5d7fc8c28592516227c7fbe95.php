...
<head>
    ...
    <title><?php echo e(Session::get('name')); ?> Dashboard</title>
...
<body>
    <div class="main-wrapper">
                ...
                <li class="nav-item dropdown noti-dropdown language-drop me-2">
                    ...
                    <div class="dropdown-menu ">
                        <div class="noti-content">
                            <div>
                                <a class="dropdown-item" href=""><i class="flag flag-us me-2"></i>English</a>
                                <a class="dropdown-item" ><i class="flag flag-ma me-2"></i>Arabic<span class="soon-badge2">soon</span></a>
                                <a class="dropdown-item" ><i class="flag flag-fr me-2"></i>Frensh<span class="soon-badge3">soon</span></a>
                            </div>
                        </div>
                    </div>
                </li>
                                    ...
                                    <a href="#">
                                        <div class="media d-flex">
                                            <span class="avatar avatar-sm flex-shrink-0">
                                                <img class="avatar-img rounded-circle" alt="User Image" src="<?php echo e(URL::to('assets/img/profiles/avatar-01.png')); ?>">
                                            </span>
                                            <div class="media-body flex-grow-1">
                                                <p class="noti-details"><span class="noti-title">Teacher X</span> has
                                                    approved <span class="noti-title">your certificate</span></p>
                                                <p class="noti-time"><span class="notification-time">1 day ago</span>
                                                </p>
                                            </div>
                                        </div>
                                    </a>
        ...
        <footer>
            <p>Copyright ©  <?php echo date('Y'); ?> FSR.</p>
        </footer>
...
</html><?php /**PATH C:\Users\zakar\Downloads\msuccess\resources\views/layouts/master.blade.php ENDPATH**/ ?>