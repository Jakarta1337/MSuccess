                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <select class="form-control select @error('class') is-invalid @enderror" name="class">
                                                ...
                                                <option value="MIT1" {{ $studentEdit->class == 'MIT1' ? "selected" :""}}>MIT_1</option>
                                                <option value="MIT2" {{ $studentEdit->class == 'MIT2' ? "selected" :""}}>MIT_2</option>
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <select class="form-control select @error('section') is-invalid @enderror" name="section">
                                                ...
                                                <option value="S1" {{ $studentEdit->section == 'S1' ? "selected" :""}}>S1</option>
                                                <option value="S2" {{ $studentEdit->section == 'S2' ? "selected" :""}}>S2</option>
                                                <option value="S3" {{ $studentEdit->section == 'S3' ? "selected" :""}}>S3</option>
                                                <option value="S4" {{ $studentEdit->section == 'S4' ? "selected" :""}}>S4</option>
                                            </select>
                                            @error('section')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
