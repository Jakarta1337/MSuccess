                ...
                <div class="card bg-comman w-100">
                    <div class="card-body">
                        <div class="db-widgets d-flex justify-content-between align-items-center">
                            ...
                            <div class="db-icon">
                                <img src="{{ URL::to('assets/img/icons/dash-icon-042.svg') }}" alt="Dashboard Icon">
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <table
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-nowrap">
                                            <a href="profile.html">
                                                <img class="rounded-circle"src="{{ URL::to('assets/img/profiles/avatar-01.png') }}" width="25" alt="Star Students"> student1
                                            </a>
                                        </td>
